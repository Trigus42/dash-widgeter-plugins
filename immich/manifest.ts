...
const settings: WidgetSettingField[] = [
  ...
  { key: 'albumIds', label: 'Albums', type: 'multiselect', help: 'Used when source is Albums.', section: 'Source', dynamicOptions: true },
  { key: 'personIds', label: 'People', type: 'multiselect', help: 'Used when source is People.', section: 'Source', dynamicOptions: true },
  { key: 'tagIds', label: 'Tags', type: 'multiselect', help: 'Used when source is Tags.', section: 'Source', dynamicOptions: true },
